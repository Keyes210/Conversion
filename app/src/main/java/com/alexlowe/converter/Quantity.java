...
public class Quantity {
    ...
    final double mValue; //final, unique value not going to change
    final Unit mUnit;
    ...
    public static enum Unit{
        tsp(1.0d), tbs(0.3333d), cup(0.0208d), oz(0.1666d), pint(0.0104d), qt(0.0052d), gal(0.0013d),
        lb(0.0125d), ml(4.9289d), lt(0.0049d), mg(5687.5d), kg(0.0057d);
    ...
    public Quantity to(Unit newUnit){
        Unit oldUnit = this.mUnit;
        return new Quantity(newUnit.fromBaseUnit(oldUnit.toBaseUnit(mValue)), newUnit);
    }
    ...
    public String toString(){
        ...
        return df.format(mValue) + " " + mUnit.name();
    }
}
